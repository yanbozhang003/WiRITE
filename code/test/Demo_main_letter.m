...
%                             csi_11(csi_cnt) = mean(csi(1,1,:));
%                             csi_33(csi_cnt) = mean(csi(3,3,:));     % test without sanitization
                        end
                        
                        fprintf('CSI sanit time: %.2f\n',toc(tStart));
                     %% csi to traj, then to img
                        ...
                        fprintf('Get trajectory time: %.2f\n',toc(tStart));
...
%                         save(['test_traj_',num2str(edge_count/2),'.mat'],'traj');
                     %% classification
                        ...
                        fprintf('Classification time: %.2f\n',toc(tStart));
